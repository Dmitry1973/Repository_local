...
class SelectItems(QWidget):
    ...
    def itemsAndPrices(self):
        """Create the widgets so user can select an item from the combo
        boxes and price from the spin bpxes
        """
        ...
        # Create list of food items and add those to
        # two separate combo boxes
    ...
    def calculateTotal(self):
        """
        Calculate and display total price from
        spin boxes and change value shown in QLabel
        """
