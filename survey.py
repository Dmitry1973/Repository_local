...
from PyQt5.QtWidgets import (QApplication, QWidget, QLabel,
                             QPushButton, QCheckBox, QButtonGroup, QHBoxLayout,
                             QVBoxLayout)
...
class DisplaySurvey(QWidget):
    ...
    def initializeUI(self):
        """
        Initialize the window and display its contects to the screen
        """
        self.setGeometry(600, 400, 400, 230)
    ...
    def displayWidgets(self):
        ...
        question = QLabel('How would you rate service today?')
        ...
        # space on both sides of widgets
